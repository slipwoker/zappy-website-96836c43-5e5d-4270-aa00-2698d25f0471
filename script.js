    ...
    if (contactForm) {
      ...
      contactForm.addEventListener('submit', function(e) {
        ...
        requiredFields.forEach(function(input) {
          ...
          if ((input.type === 'tel' || input.name === 'phone') && !validatePhone(value)) {
        ...
        var textareas = contactForm.querySelectorAll('textarea[required]');
        textareas.forEach(function(textarea) {
          ...
          if (!value) {
            showError(textarea, label + ' is required');
            isValid = false;
        ...
        contactForm.classList.add(successClass);
        ...
        if (submitBtn) {
          ...
          setTimeout(function() {
            contactForm.reset();
            contactForm.classList.remove(successClass);
      ...
      contactForm.addEventListener('blur', function(e) {
        var input = e.target;
        if (!input.matches || !input.matches('input[required], textarea[required]')) return;
        ...
        if (input.type === 'email' && !validateEmail(value)) {
          showError(input, 'Please enter a valid email address');
        } else if ((input.type === 'tel' || input.name === 'phone') && !validatePhone(value)) {
          showError(input, 'Please enter a valid phone number');
        } else {
          clearError(input);
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '96836c43-5e5d-4270-aa00-2698d25f0471',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '96836c43-5e5d-4270-aa00-2698d25f0471';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '96836c43-5e5d-4270-aa00-2698d25f0471';
